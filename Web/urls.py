...
urlpatterns = [
    ...
    path('geographical_objects/', views.GetGeographicalObjects, name='geografic_objects'),

    # Сведения о географических объектов
    path('geographical_object/<int:id>/', views.GetGeographicalObject, name='about_geografic_object'),
